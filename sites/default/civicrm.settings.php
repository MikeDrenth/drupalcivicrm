...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/drupal_test?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@localhost:3306/drupal_test?new_link=true');
  }
}
...
$civicrm_root = '/Users/Mike/sites/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/Mike/sites/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'e09e92683c106827caa18b42f20b2db3');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/Mike/sites/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
